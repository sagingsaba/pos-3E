...
<style>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
     <h1 class="invendash">WAREHOUSE</h1>
      <div class="panel panel-default">
        <div class="panel-heading clearfix">           
         <div class="pull-right">
           <a href="add_warehouse_product.php" class="btn btn-warning">Add New</a>
           <a href="add_product.php" class="btn btn-warning">Export To Products</a>
         </div>
        </div>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="barcode"> <?php echo remove_junk($warehouse['barcode']); ?></td>              
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="edit_warehouse_product.php?id=<?php echo (int)$warehouse['id'];?>" class="btn btn-warning btn-xs"  title="Edit" data-toggle="tooltip">
